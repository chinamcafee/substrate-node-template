                    ...
                    let callsite = {
                        ...
                        static META: Metadata<'static> = {
                            ::tracing_core::metadata::Metadata::new(
                                "do_something",
                                "pallet_benchmark_demo",
                                ::sp_tracing::tracing::Level::TRACE,
                                Some("pallets/benchmark/src/lib.rs"),
                                Some(56u32),
                                Some("pallet_benchmark_demo"),
    ...
    fn get_dispatch_info(&self) -> ::frame_support::dispatch::DispatchInfo {
        match *self {
            Call::do_something(ref something) => {
                let base_weight = T::DbWeight::get().writes(1) + 32_000_000;
                        ...
                        ::frame_benchmarking::benchmarking::commit_db();
                        {
                            ...
                            if lvl <= ::log::STATIC_MAX_LEVEL && lvl <= ::log::max_level() {
                                ::log::__private_api_log(
                                    ...
                                    &(
                                        "benchmark",
                                        "pallet_benchmark_demo::benchmarking",
                                        "pallets/benchmark/src/lib.rs",
                                        115u32,
                                    ),
                                );
                            }
